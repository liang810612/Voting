...
std::vector<Candidate> voting_arrange_loser_vote (std::vector<Candidate>&, int [1000][20],  std::vector<int>, int candidTotalNum);
std::vector<std::string> voting_eval(int [1000][20], std::vector<std::string>, int, int);
